...
void simplex(int var[], int &var_cnt, int &n, int &m, tMatrix &Sim)
{
	  ...
	  while (1)
	  {
		 ...
		 else // План недопустимий
		 {
			...
			int key_row = min_row;
			next_basic_m(Sim, key_row, key_col, n, m, var);
		 }
	  }
}
